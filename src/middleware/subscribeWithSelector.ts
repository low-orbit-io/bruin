...
const subscribeWithSelectorImpl: SubscribeWithSelectorImpl =
  (fn) => {
    ...
    (creator as any).$$storeMutators = [['bruin/subscribeWithSelector', undefined]] as const;
    return creator as StateCreator<ReturnType<typeof fn>, [], [['bruin/subscribeWithSelector', never]]>;
  };
