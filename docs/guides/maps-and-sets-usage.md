...
# Map and Set in Bruin

Map and Set are mutable data structures. To use them in Bruin, you must create new instances when updating.
...
Bruin detects changes by comparing references. Mutating a Map or Set doesn't change its reference:
...
See the [Maps and Sets usage guide](./maps-and-sets-usage.md) for complete code examples.
