...
> **Note:** Bruin is a derivative work based on [Zustand](https://github.com/pmndrs/zustand). We maintain compatibility with Zustand's core architecture while extending it with history management capabilities. Many of our contribution guidelines mirror Zustand's excellent practices.
...
Documentation for Bruin lives in the [`docs`](./docs/) folder as Markdown files.

1. Fork this repository.
2. Run `pnpm install` to install dependencies.
3. Navigate to the [`docs`](./docs/) folder and make necessary changes to the documentation.
4. Test your changes by reviewing the markdown files.
5. Follow step 4 and onwards from the [General](#General) guide above to bring it to the finish line.

## Upstream Contributions

Since Bruin is based on Zustand, improvements to core functionality (non-history features) may benefit from being contributed directly to [Zustand](https://github.com/pmndrs/zustand) first. This helps both projects and the broader community. We're happy to discuss whether a contribution is better suited for Bruin or upstream Zustand.
