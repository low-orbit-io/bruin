...
immutable data structures in Bruin.

## Installation

In order to use the Immer middleware in Bruin,
...
that you need to keep in mind when using Bruin with Immer.
...
Bruin checks if the state has actually changed,
