  ...
  return (
    ...
    >
      ...
      <p style={{ color: '#6b7280', fontSize: '14px', marginBottom: '16px' }}>
        These components provide all the logic with zero styling - you provide
        the UI.
      </p>
      ...
      >
        <div>
          ...
          <HeadlessTimelineCompact
            ...
            renderList={(
              entries: HistoryEntry<CounterStore>[],
              currentIndex: number,
            ) => (
              <div
                style={{
        ...
        <div>
          ...
          <HeadlessTimelineList
            store={useCounterStore}
            renderEntry={(
              entry: HistoryEntry<CounterStore>,
              index: number,
              isCurrent: boolean,
            ) => (
              <div
  ...
  return (
    <div style={{ marginBottom: '24px' }}>
      ...
      >
        ...
        <p style={{ color: '#6b7280', fontSize: '14px', marginBottom: '16px' }}>
          Same headless components, styled with Mantine UI for rapid
          development.
        </p>
      </div>
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        >
          <p>
            These examples show the <strong>headless pattern</strong> - logic
            without styling.
          </p>
