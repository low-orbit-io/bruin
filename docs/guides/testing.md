...
to test out React components that connect to Bruin**. RTL is a simple and complete React DOM
...
In the next steps we are going to setup our Vitest environment in order to mock Bruin.
